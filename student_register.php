...
<div id = "middle">
	...
	<div class="content">
		...
		<div id = "middle_section">
			...
			<form action = 'student_register.php?action=student_register ' method= 'POST' name="s">
			<table>
				<tr>
					<td>
						Surname:
			...
			<p>
			Already have an account? Click <a href="student_login.php"> here </a> to sign in.
			</form>
		...
		if (isset($_POST['regno'])){$regno = strip_tags($_POST['regno']);} 
		...
		if ($submit)
		 	{
		        ...
		        if ($surname && $firstname && $regno && $email && $password && $confirmpassword)
		        {
				        	...
				        	if (strlen($password)<26 && strlen($password)>5)
								{
									...
									mysql_query("insert into users (surname, firstname, regno, email, password) values('$surname','$firstname','$regno','$email','$password')");
								
									header("Location: student_login.php");
									//echo "You are now registered. <a href=\"student_login.php\"> Login. </a>";
