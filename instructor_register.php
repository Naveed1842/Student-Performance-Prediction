...
<div id = "middle">
	...
	<div class="content">
		...
		<div id = "middle_section">
			...
			<form action = 'instructor_register.php?action=instructor_register' method= 'POST' name="s">
			<table>
				<tr>
					<td>
						Surname:
			...
			<p>
			Already have an account? Click <a href="instructor_login.php"> here </a> to sign in.
			</form>
				        	...
				        	if (strlen($password)<26 && strlen($password)>5)
								{
									...
									//echo "You are now registered. <a href=\"instructor_login.php\"> Login. </a>";
